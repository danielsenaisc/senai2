	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<g:render template="/layouts/breadcrumb" 
					model="['section_name': "Marcas", 'section_sub': "Nova Marca"]" />
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/brand/basic_information"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/brand/channels"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/brand/audience"/>
			...
			<div class="form-actions right" style="text-align:right; padding-right:20px;">
                            ...
                            <button type="submit" formaction="${createLink(controller:'brand',action:'saveBrand')}" class="btn blue-madison"><g:message code="button.default.save"/></button>
			</div>
