	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<g:render template="/layouts/breadcrumb" 
					model="['section_name': "Coleções", 'section_sub': "Nova Coleção"]" />

			<g:form name="collection-form" url="[action:'index',controller:'collection']" class="form-horizontal">
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/collection/basic_information"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/collection/audience"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/collection/team"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/collection/attachments"/>
...
<script>
	jQuery(document).ready(function() {   
		...
		$("#menu_collections").addClass("active");
