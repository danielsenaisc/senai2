	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<g:render template="/layouts/breadcrumb" 
					model="['section_name': "Indústria", 'section_sub': "Informações"]" />

					

			<g:form name="industry-form" url="[action:'index',controller:'dashboard']" class="form-horizontal">
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/industry/basic_information"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/industry/about"/>	
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/industry/channels"/>
