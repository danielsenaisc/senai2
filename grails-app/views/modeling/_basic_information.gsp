            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="input-icon right">
                            <input name="modelingName" id="product_name" type="text" class="form-control input-xlarge" value="${modeling.getNome()}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2" style="margin-right: 10px; margin-left: 12px;">
                        <div class="form-group"> 
                            <g:select name="brandListComboBox" from="${brandList}" value="TODO" id="main_collection" class="form-control input-small input-200"/>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 radio-list">
                        <label class="radio-inline">
                            <input type="radio" name="modelingOptionRadioGenre" id="optionsRadios4" value="M" tabindex="10" ${innerModelingControl.isMascChecked(modeling)}> <g:message code="report.form.edit.gender-male"/> </label>
                        <label class="radio-inline">
                            <input type="radio" name="modelingOptionRadioGenre" id="optionsRadios5" value="F" tabindex="11" ${innerModelingControl.isFemChecked(modeling)}> <g:message code="report.form.edit.gender-female"/> </label>
                        <label class="radio-inline">
                            <input type="radio" name="modelingOptionRadioGenre" id="optionsRadios6" value="U" tabindex="12" ${innerModelingControl.isUnissexChecked(modeling)}> <g:message code="report.form.edit.gender-unissex"/> </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <div class="input-icon right">
                            <input name="modelingIndustryInternId" type="text" class="form-control input-200" value="${modeling.getIdInternoIndustria()}">
                        </div>
                    </div>
                </div>	
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="input-icon right">
                            <textarea name="modelingDescription" class="form-control input-xlarge" rows="6" maxlength="600"> ${modeling.getDescricao()} </textarea>
                        </div>
                    </div>
                </div>
