        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <g:render template="/layouts/breadcrumb" 
                    model="['section_name': "Modelagem", 'section_sub': "Nova Modelagem"]" />

                <g:form name="collection-form" url="[action:'index',controller:'modeling']" class="form-horizontal">
...
<!-- BEGIN ROW -->
                    <div class="row form-horizontal">
                        ...
                        <div class="col-md-12">
                            ...
                            <g:render template="/modeling/basic_information"/>
                ...
                <!-- END ROW -->
                    ...
                    <div class="row form-horizontal">
                        ...
                        <div class="col-md-12">
                            ...
                            <g:render template="/modeling/models_information"/>
