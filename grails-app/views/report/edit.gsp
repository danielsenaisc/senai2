...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<g:form name="report-form" url="[action:'view',controller:'report']" class="form-horizontal">
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/report/basic_information"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/report/filter_product"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/report/filter_audience"/>
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/report/filter_config"/>
			...
			<div class="form-actions right" style="text-align:right; padding-right:20px;">
				...
				<button type="submit" class="btn blue-madison"><g:message code="report.form.edit.create-report"/></button>
			</div>
