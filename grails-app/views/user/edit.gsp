	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<g:render template="/layouts/breadcrumb" 
					model="['section_name': "Indústria", 'section_sub': "Novo Usuário"]" />

					

			<g:form name="brand-form" url="[action:'index',controller:'user']" class="form-horizontal">
			...
			<div class="row form-horizontal">
				...
				<div class="col-md-12">
					...
					<g:render template="/user/basic_information"/>
